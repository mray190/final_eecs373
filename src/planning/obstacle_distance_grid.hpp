...
/**
* ObstacleDistanceGrid stores the distance to the nearest obstacle for each cell in the free space in an occupancy grid.
* 
*  - Free space in the occupancy grid is any cell whose logOdds < 0.
